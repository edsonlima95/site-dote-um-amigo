    ...
    return (
        <>
            <div className="hidden lg:flex justify-between items-center">
                <div>
                   <Link href="/"><a><span className="text-[#613387] text-2xl uppercase font-bold">ADOTE</span><span className="text-[#f8a836] text-2xl ml-2 font-bold">UM AMIGO</span></a></Link>
                </div>
                <nav className="">
